...
public:
    ...
    CPTAPI int config( double voltage, double current, double freq ); // 用户自测配置
    ...
    // return 0 成功，无错误
    // return -1, 测试失败
    CPTAPI int get_user_test_result( double *voltage, double *current, double *freq_measured = 0 );
